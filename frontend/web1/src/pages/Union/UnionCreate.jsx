...
export default function UnionCreate() {
  ...
  return (
    <div className="flex-1 p-8 space-y-8 animate-in fade-in duration-500 bg-gradient-to-br from-white to-[#f4f4f5] min-h-screen">
      {/* Header */}
      <header>
        <h1 className="text-4xl font-bold text-on-surface">Create New Union</h1>
        <p className="text-on-surface mt-1">Set up a new helper group that contractors can hire from.</p>
      </header>
            ...
            <div className="border-t border-outline-variant pt-6">
              ...
              <div className="w-full h-3 bg-surface-container-high rounded-full overflow-hidden">
                <div
                  ...
                  style={{ width: `${(selectedHelpers.length / maxCapacity) * 100}%` }}
                />
              </div>
