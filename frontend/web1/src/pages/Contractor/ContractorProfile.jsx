...
const ContractorProfile = () => {
  ...
  const metrics = [
    { label: 'Success Rate', value: '98%', icon: <ShieldCheck className="text-on-surface" /> },
    { label: 'Active Jobs', value: '42', icon: <Briefcase className="text-on-surface" /> },
    { label: 'Client Rating', value: '4.9', icon: <Star className="text-on-surface" /> },
    { label: 'Hours Logged', value: '12k', icon: <Clock className="text-on-surface" /> },
  ];
      ...
      <main className="px-10 space-y-8">
        ...
        >
          ...
          <div className="flex-grow space-y-6">
            <div>
              <h3 className="text-4xl font-bold text-on-surface tracking-tight">{profileDetails.name}</h3>
              <p className="text-lg font-semibold text-on-surface mt-1">{profileDetails.title}</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            >
              <h4 className="text-[10px] font-black text-on-surface uppercase tracking-[0.2em] mb-8 border-b border-gray-50 pb-4">Company Verification</h4>
            ...
            >
              <h4 className="text-[10px] font-black text-on-surface uppercase tracking-[0.2em] mb-8 border-b border-gray-50 pb-4">Performance Metrics</h4>
          ...
          >
            <div className="flex justify-between items-center mb-10 border-b border-gray-50 pb-4">
              <h4 className="text-[10px] font-black text-on-surface uppercase tracking-[0.2em]">Project Showcase</h4>
              <button className="text-[10px] font-black text-on-surface uppercase tracking-widest flex items-center gap-2 group">
...
const VerticalDetail = ({ label, value }) => (
  <div>
    <p className="text-[10px] font-black text-on-surface uppercase tracking-widest mb-1.5">{label}</p>
